...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.csrf()
                ...
                .permitAll()
                .antMatchers(HttpMethod.GET, "/stations")
                .permitAll()
                ...
                .permitAll()
                .antMatchers(HttpMethod.GET, "/cidadeAutocomplete")
                .permitAll()
                ...
                .permitAll()
                .antMatchers(HttpMethod.GET, "/travels/**")
                .permitAll()
                .antMatchers(HttpMethod.GET, "/profile/**")
                .authenticated()
                .antMatchers(HttpMethod.GET, "/chat/**")
                .authenticated()
                .antMatchers(HttpMethod.GET, "/admin/**")
                .hasRole("ADMIN")
                .antMatchers(HttpMethod.GET, "/userData/**")
                .hasRole("ADMIN")
                .antMatchers(HttpMethod.GET, "/travel/delete/**")
                .hasRole("ADMIN")
                .antMatchers(HttpMethod.POST, "/travel/**")
                .hasRole("ADMIN")
                .and()
                .formLogin()
                .loginPage("/login")
